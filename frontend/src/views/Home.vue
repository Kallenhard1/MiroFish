  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">A simple, universal collective intelligence engine</span>
            <span class="version-text">/ v0.1-preview</span>
          </div>
          
          <h1 class="main-title">
            Upload any report<br>
            <span class="gradient-text">Project the future instantly</span>
          </h1>
          
          <div class="hero-desc">
            <p>
              Even from a single passage, <span class="highlight-bold">MiroFish</span> can use its real-world seeds to automatically generate a matching parallel world with up to <span class="highlight-orange">millions of Agents</span>. Inject variables from a god-view perspective and search for <span class="highlight-code">"local optima"</span> in complex group interactions under dynamic conditions.
            </p>
            <p class="slogan-text">
              Rehearse the future among Agent swarms and let decisions win after a hundred trials<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            The prediction engine is standing by. Upload multiple unstructured data files to initialize a simulation sequence.
          </p>
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Standard simulations average $5 each</div>
            </div>
            <div class="metric-card">
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Real-world seed extraction & individual and group memory injection & GraphRAG build</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relationship extraction & persona generation & environment Agent simulation parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & automatic prediction requirement parsing & dynamic timeline memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Talk with anyone in the simulated world & chat with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g. if Wuhan University announces it will revoke Xiao's disciplinary action, what public opinion trend would follow?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - navigate immediately; the API call runs on the Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate to the Process page immediately (using a special marker for new projects)
    router.push({
      name: 'Process',
