        ...
        <div class="panel-header">
          ...
          <div class="header-right">
            ...
            <div class="action-buttons">
                ...
                <button class="action-btn" @click="toggleFullScreen" :title="isFullScreen ? 'Exit fullscreen' : 'Show fullscreen'">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After documents are uploaded, the LLM analyzes their content and automatically generates an ontology structure suitable for public opinion simulation (entity types + relationship types).
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, split documents into chunks and call the Zep API to build a knowledge graph and extract entities and relationships.
                </div>
              </div>
...
// Initialize - handle a new project or load an existing project
...
const renderGraph = () => {
  ...
  // Draw edges (including a transparent wide clickable line)
  ...
  // Click blank space to close the detail panel
  svg.on('click', () => {
    closeDetailPanel()
  })
