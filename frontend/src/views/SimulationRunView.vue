...
// Get maxRounds directly from query params during initialization so child components can access the value immediately
...
const handleNextStep = () => {
  // The Step3Simulation component directly handles report generation and routing.
...
const loadGraph = async (graphId) => {
  ...
  // Manual refresh or initial load still shows loading.
  if (!isSimulating.value) {
...
onMounted(() => {
  ...
  // Record maxRounds configuration (value was read from query params during initialization)
  if (maxRounds.value) {
