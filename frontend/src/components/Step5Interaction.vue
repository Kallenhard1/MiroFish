        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Send Survey into the World</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A fast chat version of the report-generation agent that can call 4 specialized tools and has MiroFish's full memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation environment state, combining Global/Local Memory mechanisms to provide deep cross-time attribution analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Uses graph-structured breadth traversal to reconstruct event propagation paths and capture the topology of full information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">A GraphRAG-based instant query interface optimized for index efficiency and quick extraction of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that can run multi-turn conversations in parallel with individuals in the simulated world and collect unstructured opinion and psychological-state data</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to explore report content in depth' : 'Chat with simulated individuals to understand their perspectives' }}
              </p>
            </div>
            <div 
...
const renderMarkdown = (content) => {
  ...
  // Clean up cases where <p><br> immediately precedes block elements (caused by extra blank lines)
  ...
  // Fix numbering for non-contiguous ordered lists: keep numbers increasing when single-item <ol> blocks are separated by paragraph content
...
const sendToAgent = async (message) => {
  ...
  addLog(`To ${selectedAgent.value.username} sent: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to an array and prefer replies from the reddit platform
...
/* Left Panel - Report Style (exactly matches Step4Report.vue) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* Fix ordered-list numbering - use CSS counters so multiple ol elements number continuously */
.message-text {
