...
if os.path.exists(project_root_env):
    ...
    # If the root directory has no .env, try loading environment variables (for production)
...
class Config:
    ...
    # JSON configuration - disable ASCII escaping so non-ASCII text displays directly (instead of \uXXXX format)
    JSON_AS_ASCII = False
    
    # LLM configuration (standard OpenAI format)
