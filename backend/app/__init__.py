...
def create_app(config_class=Config):
    ...
    # Set JSON encoding: display non-ASCII text directly (instead of \uXXXX format)
    ...
    # Print startup information only in the reloader child process (avoid duplicate prints in debug mode)
    ...
    # Register the simulation process cleanup function (ensure all simulation processes are terminated when the server shuts down)
