...
Persists project state on the server to avoid passing large amounts of data between frontend API calls
"""
...
class Project:
    ...
    # Ontology information (filled after API 1 generates it)
