...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use an LLM to generate simulation configuration parameters (time, activity, posting frequency, etc.)
        ...
        Args:
            ...
            document_text: Original document content (used by the LLM to understand context)
            defined_entity_types: Predefined entity types (optional)
            use_llm_for_profiles: Whether to use an LLM to generate detailed personas
        ...
        try:
            ...
            if progress_callback:
                progress_callback(
                    "reading", 100,
                    f"Complete, {filtered.filtered_count} entities in total",
            ...
            # Set the realtime save file path (prefer Reddit JSON format)
            ...
            # Reddit has already been saved in realtime during generation; save again here to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            if progress_callback:
                progress_callback(
                    ...
                    f"Complete, {len(profiles)} Profiles in total",
