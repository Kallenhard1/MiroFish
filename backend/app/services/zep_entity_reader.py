...
class ZepEntityReader:
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        ...
        """
        try:
            # Call the Zep API with the retry mechanism
    ...
    def filter_defined_entities(
        ...
        # Get all edges (used for later association lookup)
        all_edges = self.get_all_edges(graph_id) if enrich_with_edges else []
        
        # Build a map from node UUID to node data
        node_map = {n["uuid"]: n for n in all_nodes}
        
        # Filter entities that match the conditions
        filtered_entities = []
        ...
        for node in all_nodes:
            ...
            # If predefined types were specified, check for matches
    ...
    def get_entity_with_context(
        ...
        """
        try:
            # Get the node with the retry mechanism
