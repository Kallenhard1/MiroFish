...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        Args:
            ...
            process_func: Processing function that receives a single item as its argument
            exceptions: Exception types to retry
            continue_on_failure: Whether to continue processing other items after one item fails
