"""
Action logger
Records each Agent action in OASIS simulations for backend monitoring
...
class SimulationLogManager:
    ...
    Manage all log files, separated by platform
    """
...
# Global logger instance (Compatibility with old interface)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Get global logger instance (Compatibility with old interface)"""
